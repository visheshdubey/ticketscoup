...
import { ClientRecentTicketListItemActions } from './client-recent-ticket-list-item-actions';

type Props = {
    invoice: Invoice;
};

export function ClientRecentTicketListItem({ invoice }: Props) {
    return (
        <div key={invoice.id} className="flex flex-col gap-2 border-b border-[#EAECEF] py-4">
            <div className="flex justify-between">
                ...
                <ClientRecentTicketListItemActions invoice={invoice} />
            </div>
