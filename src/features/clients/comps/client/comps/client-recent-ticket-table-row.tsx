...
import { ClientRecentTicketTableRowActions } from './client-recent-ticket-table-row-actions';

type Props = {
    invoice: Invoice;
};

export function ClientRecentTicketTableRow({ invoice }: Props) {
    return (
        <TableRow key={invoice.id}>
            ...
            <TableCell className="py-3">
                <ClientRecentTicketTableRowActions invoice={invoice} />
            </TableCell>
        </TableRow>
    );
}
