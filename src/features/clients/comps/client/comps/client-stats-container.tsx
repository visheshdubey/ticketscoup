...
import { ClientStatsDurationSelector } from './client-stats-duration-selector';
    ...
    return (
        <>
            <div className="flex justify-between md:justify-start gap-5">
                ...
                <ClientStatsDurationSelector options={options} handleSelectChange={handleSelectChange} className="w-fit" />
            </div>
