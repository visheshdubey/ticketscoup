...
import { ClientRecentTicketTableHeader } from '../client-recent-ticket-table-header';
import ClientRecentTicketTable from '../client-recent-ticket-table';
import ClientRecentTicketList from '../client-recent-ticket-list';
        ...
        <>
            ...
            <DashboardPageSection>
                <div className="bg-white md:h-full flex flex-col mt-10 lg:mt-2">
                    <ClientRecentTicketTableHeader filtersApplied={filtersApplied} />

                    <div className="pt-5 hidden md:block">
                        <ClientRecentTicketTable invoices={invoices} />
                    </div>

                    <div className="md:hidden pt-4">
                        <ClientRecentTicketList invoices={invoices} />
                    </div>
                </div>
            </DashboardPageSection>
        </>
