...
import { RecentTicketTableHeader } from '../recent-ticket-table-header';
import RecentTicketTable from '../recent-ticket-table';
        ...
        <>
            ...
            <DashboardPageSection>
                <div className="bg-white md:h-full flex flex-col mt-10 lg:mt-2">
                    <RecentTicketTableHeader filtersApplied={filtersApplied} />

                    <div className="pt-5 hidden md:block">
                        <RecentTicketTable invoices={invoices} />
                    </div>

                    <div className="md:hidden pt-4">
                        <RecentTicketList invoices={invoices} />
                    </div>
                </div>
            </DashboardPageSection>
        </>
