...
import { StaffMemberStatDurationSelector } from './staff-member-stats-duration-selector';
...
export function StaffMemberStatsContainer({
    WidgetList,
    handleSelectChange,
    handleShowMore,
    showMore,
    ...
    return (
        <>
            <div className="flex justify-between md:justify-start gap-5">
                ...
                <StaffMemberStatDurationSelector options={options} handleSelectChange={handleSelectChange} className="w-fit" />
            </div>
